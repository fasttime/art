...
(function ()
{
     ...
     * @param [...args]
     * Optional arguments.
     * Each of these may be a node to be appended to the taget node, a function to be called with
     * the target node as only argument, an object whose properties shall be assigned to the taget
     * node, or a string of text to be appended to the target node.
     *
